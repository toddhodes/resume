...
\begin{tabular}{p{5.2in}@{\hspace{1.5cm}}l}
	...
	\em  Avast, s.r.o. 	& \em January 2021 \\[4pt]
	   ...
	   Worked in a monorepo with modules per feature and flavors for each app. See below. \\[9pt]
	   
	\em Director of Engineering (Mobile)	 \& Architect & \em October 2014 -  \\
	\em  AVG Technologies, LLC 	& \em July 2016 \\[4pt]
	
	   AVG acquired LocationLabs in 2014 for \$220,000,000.00.  As part of the agreement,
	   key hires were kept on for 2 years to continue the business, including myself. I 
	   continued working the android version of the white-label family safety applications. 
	   Worked in a monorepo with modules per feature and flavors for each app. See below. \\[9pt]
...
\begin{tabular}{p{5.2in}@{\hspace{1.5cm}}l}
	...
	\em  WaveMarket, Inc. 	& \em June 2010 \\[4pt]
	   ...
	   for SysOps, server, and client, writing the tools and software for all three, to
	   ...
	   Partner Engineering / integration design, visiting carriers all over the world after we had signed contracts
	   with them and were hammering out integration points (authentication, location access, 
	   providing unmetered data atop metered plans, etc).
	   \smallskip
