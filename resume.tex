...
\begin{itemize}
\item Kotlin, Java, shell (sh/bash/ksh), SQL, C, C++, C\#, JavaScript, python, Go. \\[-18pt]
...
\item Android libraries:
	Kotlin, RxJava2, Mosby Model/View/Presenter (MVP), ViewModel, Jetpack, Material Design,
	   Amplitude, Adjust, Conductor, Dagger, Branch.io, Cloudinary, Dagger, Epoxy, Lottie, EventBus, Crashlytics,
...
\item Collaboration tools: Jira, Confluence, Miro, Zeplin, Bugzilla.    \\[-18pt]
\item AWS: EC2, S3, ELB, EMR, security, provisioning.  \\[-18pt]
...
\begin{tabular}{p{5.2in}@{\hspace{1.5cm}}l}
	...
	\bf  Senior Staff Engineer	& January 2021 \\[4pt]
	   ...
	   which I helped architect.
	   Provided programming \& architecture, 
		feature ownership \& lifecycle, build support, tools support, infrastructure support, and cross-team 
	...
	\bf   Director of Mobile Technologies \& Senior Software Engineer	& October 2014 \\[4pt]
