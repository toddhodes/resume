...
\end{bf}
	   ...
	   \begin{itemize}
		...
		Verizon FamilyBase,
		AT\&T FamilyMap}: Major contributor to a massive Android monorepo; programming \& architecture, 
		ownership of the entire CI/CD build lifecycle, feature ownership, tools support, team 
		technical leadership. Solved ongoing ownership issues around support tooling by wrting and maintaining 
		scripts to handle what no one else was willing to, in addition to all the above. \\[-16pt]
