...
\begin{tabular}{p{5.2in}@{\hspace{1.5cm}}l}
	...
	\bf  Director of Engineering (Mobile), Senior Scientist & October 2014 \\[4pt]
...
\smallskip \\[-3pt]
\>    Todd D. Hodes, Randy H. Katz \\
\>\>      ``Enabling `Smart Spaces:' Entity Description and User Interface Generation  for a   \\
\>\>\>   Heterogeneous Component-Based Distributed System,'' \\
